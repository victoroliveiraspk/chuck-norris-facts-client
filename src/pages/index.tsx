  ...
  return (
    <>
      <form className='flex flex-col items-center relative' style={{ backgroundColor: 'rgb(155,109,162)' }} onSubmit={onSubmitHandler}>
        ...
        <input className='search-input shadow appearance-none border rounded w-10/12 sm:w-6/12 py-4 px-3 text-gray-700 focus:outline-none absolute' placeholder='Search...' style={{ bottom: '-25px' }} name='searchQuery' autoFocus autoComplete='off'/>
      </form>
